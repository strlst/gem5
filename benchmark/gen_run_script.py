...
def generate_configurations():
    ...
    aim_params = {
        ...
        "memsec": [False if i == 0 else True for i in range(10)],
        "aim-aes-units": [0, 1, 1, 1, 1, 1, 1, 1, 4, 4],
        "aim-aes-enc-cycles": [0, 80, 80, 80, 80, 80, 80, 1, 80, 80],
        "aim-aes-dec-cycles": [0, 80, 80, 80, 80, 80, 80, 1, 80, 80],
        "aim-aes-enc-ii": [0, 10, 10, 10, 10, 10, 10, 1, 10, 10],
        "aim-aes-dec-ii": [0, 10, 10, 10, 10, 10, 10, 1, 10, 10],
        "aim-mac-units": [0, 1, 1, 1, 1, 1, 1, 1, 4, 4],
        "aim-mac-cycles": [0, 40, 40, 40, 40, 40, 40, 1, 40, 40],
        "aim-mac-ii": [0, 5, 5, 5, 5, 5, 5, 1, 5, 5],
        "metadata-cache-size": [
            "0KiB",
            "32KiB",
            "32KiB",
        ...
        "metadata-cache-assoc": [0, 8, 8, 8, 8, 8, 32, 8, 8, 8],
        "int-trb-size": [0, 1, 4, 4, 4, 64, 1, 1, 1, 4],
        "int-merge-req": [3 <= i <= 5 or i == 9 for i in range(10)],
        "int-defrag-req": [4 <= i <= 5 or i == 9 for i in range(10)],
        "int-parallel-dispatch": [i > 1 for i in range(10)],
    }
