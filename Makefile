...
presentation:
	python3 benchmark/gen_summary.py --font-size 64 -p plots -g
	python3 benchmark/gen_summary.py --font-size 64 -f memsec_none,memsec_full,memsec_basic -p plots_general -g
	python3 benchmark/gen_summary.py --font-size 64 -f memsec_none,memsec_no_delay,memsec_basic -p plots_pre_optimization -g
	python3 benchmark/gen_summary.py --font-size 64 -f memsec_basic,memsec_buff,memsec_merge,memsec_defrag,memsec_similar -p plots_buffered -g
	python3 benchmark/gen_summary.py --font-size 64 -f memsec_none,memsec_basic,memsec_no_delay,memsec_aes_units -p plots_delay -g
