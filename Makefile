...
GEM5_CONFIG_AIM_PERF:=--aim-aes-enc-cycles=80 --aim-aes-dec-cycles=80 --aim-aes-enc-ii=20 --aim-aes-dec-ii=20 --aim-mac-cycles=40 --aim-mac-ii=10 --metadata-cache-size=1024KiB --metadata-cache-assoc=8 --int-trb-size=128 --int-merge-req --int-defrag-req
