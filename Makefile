...
spec:
	$(GEM5) -d $(SPECOUTDIR) $(GEM5_CONFIG) $(GEM5_CONFIG_SE) $(GEM5_CONFIG_SPEC) $(GEM5_CONFIG_CACHE) $(GEM5_CONFIG_AES) $(GEM5_CONFIG_MAC) $(GEM5_CONFIG_CRYPTO) --cmd $(SPECCMD) $(SPECOPTIONS) $(SPECSTDIN) $(SPECSTDOUT) $(SPECSTDERR)
